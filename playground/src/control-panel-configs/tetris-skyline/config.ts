...
const config: ComponentConfig = {
  ...
  controls: [
    ...
    { key: 'spawnEveryMs', label: 'Spawn interval (ms)', type: 'number', min: 100, max: 5000, step: 50, group: 'Timing' },
    { key: 'columnClearAnimMs', label: 'Clear animation (ms)', type: 'number', min: 50, max: 2000, step: 50, group: 'Timing' },
    ...
    { key: 'initialTerrainPercent', label: 'Initial terrain height', type: 'number', min: 0, max: 1, step: 0.05, group: 'Terrain' },
    { key: 'terrainRoughness', label: 'Roughness', type: 'number', min: 0, max: 5, step: 1, group: 'Terrain' },
    { key: 'holeChance', label: 'Hole chance', type: 'number', min: 0, max: 0.5, step: 0.001, group: 'Terrain' },
